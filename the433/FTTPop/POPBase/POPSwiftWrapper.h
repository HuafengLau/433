...
@property (strong)POPAnimation* ref;
...
@property (strong)POPPropertyAnimation* ref;
...
@property (strong)POPSpringAnimation* ref;
...
@property (strong)POPBasicAnimation* ref;
...
@property (strong)POPDecayAnimation* ref;
...
@property (strong)POPAnimatableProperty* ref;
